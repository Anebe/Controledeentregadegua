...
class ExampleUnitTest() : KoinTest {
    ...
    fun adsasd() = runTest{
        ...
        println(itenspedidosQuery.getAllItensByPedidoId(900).buildExecuteAsSList())
//        println(itenspedidosQuery.getAllItensByPedidoId(10).buildExecuteAsSList())
//        println(itenspedidosQuery.getAllItensByPedidoId(11).buildExecuteAsSList())
//        println(itenspedidosQuery.getAllItensByPedidoId(12).buildExecuteAsSList())
    }
